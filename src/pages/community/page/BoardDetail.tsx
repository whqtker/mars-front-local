...
const BoardDetail = () => {
    ...
    useEffect(() => {
        if (postId) {
            fetch(`${import.meta.env.VITE_CORE_API_BASE_URL}/${postId}`)
    ...
    const handleLike = async () => {
        try {
            const response = await fetch(
                `${import.meta.env.VITE_CORE_API_BASE_URL}/${postId}/like`,
                {
                    method: 'POST',
                    credentials: 'include', // 세션 쿠키 포함
                },
    ...
    const handleCommentSubmit = (e: FormEvent<HTMLButtonElement>) => {
        ...
        fetch(`${import.meta.env.VITE_CORE_API_BASE_URL}/${postId}/comments`, {
            method: 'POST',
            headers: {
